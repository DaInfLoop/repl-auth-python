...
if GEVENT_SHOW_PAUSED_GREENLETS:
    ...
    def _get_paused_name(py_db, g):
        ...
        while use_frame is not None and py_db.apply_files_filter(
            use_frame, use_frame.f_code.co_filename, True
        ):
            frame = use_frame
        ...
        return f'{type(g).__name__}: {use_frame.f_code.co_name} - {basename(use_frame.f_code.co_filename)}'
