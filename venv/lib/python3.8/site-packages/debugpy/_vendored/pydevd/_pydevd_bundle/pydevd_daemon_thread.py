...
class PyDBDaemonThread(threading.Thread):
    ...
    def _on_run(self):
        if self._target_and_args is None:
            raise NotImplementedError(f'Should be reimplemented by: {self.__class__}')
...
def run_as_pydevd_daemon_thread(py_db, func, *args, **kwargs):
    ...
    t.name = f'{func.__name__} (pydevd daemon thread)'
    t.start()
    return t
